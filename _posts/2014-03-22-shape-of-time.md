...
当你看到这个公式的时候，似乎一切都清楚了。当 V的速度相比较于光速很小的时候，则$\sqrt{1-\frac{v^2}{c^2}}$约等于1，这个公式就又退回了我们熟悉的伽利略变换式中的 t = t`。有了这个公式你就可以自己算一算你以0.9光速运动一年，你可以年轻多少天了（48天21小时37分2秒 ，才这么点？）。其实你自己是感受不到时间变慢的，而只是相对于出发时那个自己你年轻了。
