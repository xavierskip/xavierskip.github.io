...
你可能会说你怎么还在用 Anthropic 公司的产品呢？A\ 不是搞”XXX与狗不得入内“那一套的吗？好把，如果是你遵守用户协议在先，然后被封了号，我支持你。如果不是，你应该问的是人家有没有逼你使用？

行，你也可以来反问我，人家也没有欢迎你，你不是也违法用户协议去用的吗？你说的没错。但是出门在外，身份都是自己给的，更何况上网冲浪呢？如果你真的爱惜自己的身份，你都不该出现在这里。如果我的号被封了，我不会抱怨。举一个不一定很恰当但是更容易明白的例子，网上铺天盖地的曝光理想车主的乱停车乱开车的行为，被网友一致嘲讽，假如你是理想车主，同时你平时都是守规矩开车，你会觉得自己被嘲讽了吗？不会吧。如果你自己觉得被嘲讽到了，那我只能觉得你也是乱停车乱开车的一份子。

我看不起的那些这几天到处宣扬 Anthropic 是恶魔，过几天 Claude 新模型发布了又开始宣传使用感受、教程之类的，看不起的是这种人。

我从很早就开始用 Claude 了，那个时候 openAI 的 chatgpt 发布没多久，引起轰动服务也不稳定，常常免费配额不够或者网络故障无法使用，那个时候就转头用上了 Claude，哪个能用用哪个。就一直用到了现在，**没被封号过，但是也没有充过值**。其实我可以尝试买苹果商店充值卡来充值订阅使用的，主要是因为贵，其次是被大量的封号案例所教育到了。**以前搞独立开发只是赚不到钱而已，现在搞开发去充值AI工具成了倒贴、亏钱了**。
...
如果你想自定义你的状态栏，可以直接照抄[官方文档里的例子](https://code.claude.com/docs/zh-CN/statusline#display-multiple-lines)，选择 node.js 的哪个脚本就行。
